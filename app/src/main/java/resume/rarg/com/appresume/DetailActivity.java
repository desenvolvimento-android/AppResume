...
public class DetailActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataItem = DataProvider.dataList().get(getIntent().getIntExtra(EXTRA_PARAM_ID, 0));
    ...
    private void loadPlace() {
        mTitle.setText(dataItem.name);
        mImageView.setImageResource(dataItem.getImageResourceId(this));
    }
    ...
    private void getPhoto() {
        Bitmap photo = BitmapFactory.decodeResource(getResources(), dataItem.getImageResourceId(this));
        colorize(photo);
    }
    ...
    private void applyPalette(Palette mPalette) {
        ...
        Bitmap photo = BitmapFactory.decodeResource(this.getResources(), dataItem.getImageResourceId(this));

        Palette.generateAsync(photo, new Palette.PaletteAsyncListener() {
            public void onGenerated(Palette palette) {
                int bgColor = palette.getDarkVibrantColor(getResources().getColor(android.R.color.black));
